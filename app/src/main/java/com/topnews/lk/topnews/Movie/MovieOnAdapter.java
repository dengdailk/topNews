 ...
 *
 * @author lk
 * @date 2018/12/26 21 02
 */
public class MovieOnAdapter extends BaseRecyclerViewAdapter<MovieBean.SubjectsBean> {
    public MovieOnAdapter(Context context, List<MovieBean.SubjectsBean> list) {
        super(context, list);
    }

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.items_movie_on, parent, false);
